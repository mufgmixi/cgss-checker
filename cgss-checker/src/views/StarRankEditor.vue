...
// App.vue と同じマッピングを使用
const rarityMapping = {
  'ノーマル': { folder: 'N', csv: '${import.meta.env.BASE_URL}data/csv/cgss_n_card_list.csv' },
  'レア':    { folder: 'R', csv: '${import.meta.env.BASE_URL}data/csv/cgss_r_card_list.csv' },
  'Sレア':   { folder: 'SR', csv: '${import.meta.env.BASE_URL}data/csv/cgss_sr_card_list.csv' },
  'SSレア':  { folder: 'SSR', csv: '${import.meta.env.BASE_URL}data/csv/cgss_ssr_card_list.csv' }
};
